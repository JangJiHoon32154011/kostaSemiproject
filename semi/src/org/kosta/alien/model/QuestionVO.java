...
public class QuestionVO {
   ...
   public QuestionVO(String questionNo, String title, String id, String contents, String category, int hits,
         int answerCount, String picture) {
      super();
   ...
   public QuestionVO(String questionNo, String title, String contents, String category, String picture) {
      super();
      this.questionNo = questionNo;
      this.title = title;
      this.contents = contents;
   ...
   public QuestionVO(String title, String contents, String category, String picture) {
      super();
      this.title = title;
   ...
   public String toString() {
      return "QuestionVO [questionNo=" + questionNo + ", title=" + title + ", id=" + id + ", contents=" + contents
            + ", category=" + category + ", hits=" + hits + ", answerCount=" + answerCount + ", picture=" + picture
            + "]";
   }
